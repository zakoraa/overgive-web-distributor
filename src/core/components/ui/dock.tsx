...
const dockVariants = cva(
  "supports-backdrop-blur:bg-white/10 mx-auto flex h-[3rem] w-max items-center justify-center gap-2 rounded-2xl border border-gray-400 p-2 backdrop-blur-md",
);
